    ...
    <>
      <div className="bannar py-[256px] bg-[url('../public/bannar.png')] bg-cover bg-center object-cover">
        <Container>
          ...
          <Link href='#' className={`${roboto.className} bg-red-400 py-4 px-[35px] rounded-[30px] font-medium text-base leading-[170%] capitalize text-[#fff] bannarbtn`}>Learn more</Link>
        </Container>
      </div>
